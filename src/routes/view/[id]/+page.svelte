<script lang="ts">
  import {FKtype} from './store'
  import { onMount, tick } from 'svelte';
  import { page } from '$app/stores'; // ✅ اضافه شد
...
<main>
  ...
  <button class="btn" on:click={() => showSave = true}>ذخیره</button></div>
